...
export class creatingfixedtables1673608722823 implements MigrationInterface {
    name = 'creatingfixedtables1673608722823'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "diagnostic" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "date" date NOT NULL, "description" text NOT NULL, "userId" uuid, "medicId" uuid, CONSTRAINT "PK_98c9b0b51c24cd981d15ee3091b" PRIMARY KEY ("id"))`);
