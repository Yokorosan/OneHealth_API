...
export class creatingandupdatingtables1673876209898 implements MigrationInterface {
    name = 'creatingandupdatingtables1673876209898'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_medic" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(75) NOT NULL, "email" character varying(100) NOT NULL, "password" character varying(100) NOT NULL, "phone" character varying(15) NOT NULL, "isWhatsApp" boolean NOT NULL DEFAULT true, "isActive" boolean NOT NULL DEFAULT true, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "addressId" uuid NOT NULL, "specialityId" uuid NOT NULL, CONSTRAINT "REL_4f22701c22147f1492e8baab29" UNIQUE ("addressId"), CONSTRAINT "PK_2f4159e05099a63620b5506350c" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "scheduled_appointment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying(20) NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid NOT NULL, "medicId" uuid NOT NULL, CONSTRAINT "PK_b947d59cd88e872b295c6e4069a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "diagnostic" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "date" date NOT NULL, "description" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userId" uuid NOT NULL, "medicId" uuid NOT NULL, CONSTRAINT "PK_98c9b0b51c24cd981d15ee3091b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "diagnostic" ADD CONSTRAINT "FK_1b3b767755ace36ebfcf92c6bb8" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "diagnostic" DROP CONSTRAINT "FK_1b3b767755ace36ebfcf92c6bb8"`);
