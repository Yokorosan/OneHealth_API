...
export class updatingAndFixingEntitiesAndTables1673909356811 implements MigrationInterface {
    name = 'updatingAndFixingEntitiesAndTables1673909356811'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "scheduled_appointment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying(20) NOT NULL, "date" date NOT NULL, "hour" TIME NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "medicId" uuid, CONSTRAINT "PK_b947d59cd88e872b295c6e4069a" PRIMARY KEY ("id"))`);
